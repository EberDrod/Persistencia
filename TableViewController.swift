...
import UIKit
//No olvidar acceder a la libreria
import CoreData
...
class TableViewController: UITableViewController {
    ...
    // Sustituir el String Memoria  por  Optionals
    ...
    /// Index Path reporcadar que es para mandar llamar el string
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ///Configuracion del Identificador Importante
